module.exports = {
  siteUrl: "https://sebuscaimagenes.com", // Site domain. Do not include a trailing slash!

  postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

  siteTitleMeta: "sebuscaimagenes", // This allows an alternative site title for meta data for pages.
  siteDescriptionMeta:
  ...
  shortTitle: "sebuscaimagenes", // Used for App manifest e.g. Mobile Home Screen
  siteIcon: "favicon.png", // Logo in /static dir used for SEO, RSS, and App manifest
  backgroundColor: "#e9e9e9", // Used for Offline Manifest
  themeColor: "#15171A", // Used for Offline Manifest
  apiUrl: "https://reshet.jetdomains.co.il/sebuscaimagenes",
  subscribeWidget: {
    visible: false,
    title: "sebuscaimagenes",
  ...
  header: {
    navigation: [
      {
        label: "Homepage",
        url: "https://sebuscaimagenes.com/",
      },
      {
        label: "Contact",
        url: "https://sebuscaimagenes.com/contact",
      },
    ],
  },
  footer: {
    ...
    navigation: [
      ...
      {
        label: "Sitemap",
        url: "https://sebuscaimagenes.com/sitemap.xml",
      },
